/* ════════════════════════════════════════════════════════════
   ...
   Split out of App.tsx into its own file: Icon is a plain object of
   components (not itself a component), and Fast Refresh breaks when a
   file exports both components and non-component values.
════════════════════════════════════════════════════════════ */
